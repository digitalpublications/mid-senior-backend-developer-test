...
- Να γραφτεί ένα must use plugin (`mu-plugin`) ως μέρος του repo, το οποίο καλεί μία εφαρμογή που θα βρίσκεται στο `src/App` και φορτώνεται με `PSR-4` με τις ανάλογες οδηγίες στο `composer.json` (βλ. παρακάτω), η οποία:
